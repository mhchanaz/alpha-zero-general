...
raw_args = {
    'numIters': 1000,
    'numEps': 7,              # Number of complete self-play games to simulate during a new iteration.
    'tempThreshold': 15,        #
...
# Change the checkpoint if training is halted and need to reload!!
...
def main():
    ...
    if args.load_model:
        ...
        log.warning('Not loading a checkpoint (Here)!')
